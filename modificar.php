...
if($_POST){
    ...
    $conexion = new conexion();
    // $sql = "UPDATE `Proyectos` SET `nombre` = '$nombre_proyecto' , `imagen` = '$imagen', `descripcion` = '$descripcion' WHERE `proyectos`.`id` = '$id';"; MODIFICAR DESPUES
                            ...
                            <div>
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div class="d-flex justify-content-center align-item-center">
                                        <img class="img__modificar" src="assets/img/<?php echo $fila['Imagen']; ?>">
                                    </div>
                                </div>
